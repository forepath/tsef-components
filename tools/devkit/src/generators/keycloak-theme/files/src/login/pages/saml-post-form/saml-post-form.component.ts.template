...
export class SamlPostFormComponent
  extends ComponentReference
  implements AfterViewInit
{
  kcContext =
    inject<Extract<KcContext, { pageId: 'saml-post-form.ftl' }>>(
      KC_LOGIN_CONTEXT,
    );
  ...
  htmlFormElement =
    viewChild<ElementRef<HTMLFormElement>>('setHtmlFormElement');

  ngAfterViewInit(): void {
    if (
      this.htmlFormElement() === null ||
      this.htmlFormElement() === undefined
    ) {
      return;
    }
